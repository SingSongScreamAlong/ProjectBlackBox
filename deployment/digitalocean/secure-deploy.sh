#!/bin/bash
# BlackBox Secure Console Deployment Script
# Run this script directly on your DigitalOcean droplet through the console

set -e

echo "🚀 BlackBox Hybrid Cloud Secure Deployment"
echo "============================================"
...
# Create Docker Compose file with secure environment variables
...
OPENAI_API_KEY="$OPENAI_API_KEY" ELEVENLABS_API_KEY="$ELEVENLABS_API_KEY" docker-compose up -d --build
