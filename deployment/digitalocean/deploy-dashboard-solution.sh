#!/bin/bash
# BlackBox Dashboard Deployment Script (Solution Version)
# This script deploys the simplified dashboard to your DigitalOcean droplet with proper build context
...
echo "🚀 BlackBox Dashboard Deployment (SOLUTION VERSION)"
echo "==============================="
...
scp -o ConnectTimeout=5 nginx.conf $SSH_USER@$DROPLET_IP:$REMOTE_DIR/nginx.conf || { 
